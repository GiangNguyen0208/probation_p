...
Mirrors the data collector's setup so every service emits JSON logs
with a stable set of keys: timestamp, level, logger, event, and any
bound context. This makes the logs machine-parseable for the
observability stack added in Phase 5.
"""
