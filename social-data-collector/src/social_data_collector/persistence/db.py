...
A single process-wide engine is created lazily on first use. The
session factory yields short-lived sessions for repository functions
and Celery tasks. The same engine is used by Alembic for migrations.
"""
...
def reset_for_tests() -> None:
    """Drop cached engine and session factory. Tests only."""
